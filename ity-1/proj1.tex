...
\usepackage{alltt, dirtytalk, changepage}
...
Česká sazba se oproti okolnímu světu v~některých aspektech mírně liší. Jednou z~odlišností je sazba uvozovek. Uvozovky se v~češtině používají převážně pro zobrazení přímé řeči, zvýraznění přezdívek a ironie. V~češtině se používají uvozovky typu \uv{9966} místo \say{anglických} uvozovek nebo "dvojitých" uvozovek. Lze~je sázet připravenými příkazy nebo při použití UTF-8 kódování i přímo.\par
