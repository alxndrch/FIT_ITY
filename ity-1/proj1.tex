...
\quad
{\fontfamily{pag} \selectfont Čím více druhů,} \textsc{řezů,} {\tiny velikostí}, 
...
\end{adjustwidth}
\bigskip
\quad {\footnotesize Tímto} pravidlem se nikdy \textbf{nesmíte} řídit. Příliš časté {\large zvýrazňování} textových elementů a změny velikosti {\fontsize{21}{25} \selectfont písma} jsou známkou amatérismu autora a působí {\fontsize{30}{36} \selectfont velmi} rušivě. Dobře navržený dokument nemá obsahovat více než 4 řezy či druhy písma. Dobře navržený dokument je decentní, ne chaotický.
